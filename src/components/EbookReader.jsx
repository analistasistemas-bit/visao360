...
// Accessibility: Navigation card elements use aria-label attributes throughout this component.
export default function EbookReader() {
    const [isLoaded, setIsLoaded] = useState(false);

    useEffect(() => {
        // Pequeno delay para permitir que a capa (leve) renderize instantaneamente
    ...
    return (
        <div className="ebook-reader-container w-full min-h-screen bg-slate-50 pt-8 pb-32 overscroll-contain">
            {/*  CAPA  */}
            <EbookCover />

            {!isLoaded ? (
                <div className="flex flex-col items-center justify-center py-32 animate-in fade-in duration-700">
                    <div className="w-14 h-14 border-4 border-avil-blue/10 border-t-avil-orange rounded-full animate-spin mb-6 shadow-xl shadow-avil-orange/10"></div>
                    <p className="text-avil-blue-dark font-black text-xl tracking-tight mb-2">Preparando Visão 360</p>
                    <p className="text-slate-400 text-sm font-medium animate-pulse">Otimizando sua experiência de leitura...</p>
                </div>
            ) : (
